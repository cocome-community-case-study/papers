...
This section introduces \deleted{the }three evolution scenarios \added{for \CoCoME}.
\added{The first scenario presents a mobile application which can be used with \CoCoME.}
A microservice-based variation of \CoCoME is introduces in the second scenario.
\added{In the last scenario a container virtualization is introduced.}
\added{The goal is to enable} \deleted{of the}\added{a} hybrid cloud-based variation of \CoCoME.

%\todosk{Wer, was, warum}
\section{Adding a Mobile App}
